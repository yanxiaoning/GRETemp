...
public boolean onMenuItemSelected(int featureId,MenuItem item){
	...
	case(MENU_BACK_TO_MAIN):
		...
		intent.setClass(MyListView.this, MainPage.class);
...
public  void onItemClick (AdapterView<?> parent, View view, int position, long id){
	...
	Intent intent=new Intent();
	intent.setClass(MyListView.this, HardWordPage.class);
...
if(keyCode == KeyEvent.KEYCODE_BACK){
	...
	{
		Intent intent=new Intent();
		intent.setClass(MyListView.this, LogView.class);
	...
	{
	Intent intent=new Intent();
	intent.setClass(MyListView.this, WordPage.class);
